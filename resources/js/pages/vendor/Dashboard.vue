...
<template>
    ...
    <VendorLayout>
        ...
        <div v-if="!hasStore" class="flex items-center justify-center min-h-[calc(100vh-4rem)] p-6">
            <div class="w-full max-w-md bg-white rounded-xl border border-border shadow-sm overflow-hidden">
                ...
                <div class="px-6 py-8 text-center" style="background:#245c4a">
                    ...
                    <p class="text-sm" style="color:rgba(255,255,255,0.75)">Get started by adding your store information</p>
                </div>
                ...
                <div class="px-6 pb-6">
                    <button
                        @click="showStoreSetupModal = true"
        ...
        <!-- ── Pending approval ── -->
        <div v-else-if="hasStore && !storeIsApproved" class="flex items-center justify-center min-h-[calc(100vh-4rem)] p-6">
            <div class="w-full max-w-md bg-white rounded-xl border border-border shadow-sm text-center p-10">
                ...
                <div class="inline-flex items-center gap-2 text-sm font-medium px-4 py-2 rounded-full border"
        ...
        <div v-else class="p-6 flex flex-col gap-5">
            ...
            <div class="flex items-start justify-between gap-5">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-widest mb-1 flex items-center gap-1"
                       style="color:#245c4a">
                ...
                <!-- Revenue summary -->
                <div class="rounded-xl px-5 py-3.5 flex-shrink-0 shadow-md relative overflow-hidden"
                     style="background:#245c4a;min-width:160px">
                    <div class="absolute -top-6 -right-6 w-20 h-20 rounded-full"
                         style="background:radial-gradient(circle,rgba(197,160,89,.2) 0%,transparent 65%)"></div>
            ...
            <div class="grid grid-cols-4 gap-3">
                ...
                <!-- Orders -->
                <div class="bg-white rounded-xl border border-border shadow-sm p-4 relative overflow-hidden
                    ...
                    <div class="absolute bottom-0 left-0 right-0 h-[3px]"
                         style="background:linear-gradient(90deg,#245c4a,#3d7a5c)"></div>
                    <div class="flex items-start justify-between mb-3">
                        <div class="w-9 h-9 rounded-md flex items-center justify-center"
                             style="background:rgba(36,92,74,.1)">
                            <svg class="w-4 h-4" style="color:#245c4a" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="h-1 rounded-full" style="background:hsl(0 0% 92.1%)">
                        <div class="h-full rounded-full transition-all duration-1000"
                             style="width:58%;background:linear-gradient(90deg,#245c4a,#3d7a5c)"></div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-border shadow-sm p-4 relative overflow-hidden
                    ...
                    <div class="absolute bottom-0 left-0 right-0 h-[3px]"
                         style="background:linear-gradient(90deg,#C5A059,#d9b87a)"></div>
                    <div class="flex items-start justify-between mb-3">
                        <div class="w-9 h-9 rounded-md flex items-center justify-center"
                             style="background:rgba(197,160,89,.14)">
                    ...
                    <div class="h-1 rounded-full" style="background:hsl(0 0% 92.1%)">
                        <div class="h-full rounded-full transition-all duration-1000"
                             style="width:74%;background:linear-gradient(90deg,#C5A059,#d9b87a)"></div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-border shadow-sm p-4 relative overflow-hidden
                            transition-all hover:-translate-y-0.5 hover:shadow-md cursor-default">
                    <div class="absolute bottom-0 left-0 right-0 h-[3px]"
                         style="background:linear-gradient(90deg,hsl(197 37% 24%),hsl(197 37% 44%))"></div>
                    <div class="flex items-start justify-between mb-3">
                    ...
                    <div class="h-1 rounded-full" style="background:hsl(0 0% 92.1%)">
                        <div class="h-full rounded-full transition-all duration-1000"
                             style="width:42%;background:linear-gradient(90deg,hsl(197 37% 24%),hsl(197 37% 44%))"></div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-border shadow-sm p-4 relative overflow-hidden
                            transition-all hover:-translate-y-0.5 hover:shadow-md cursor-default">
                    <div class="absolute bottom-0 left-0 right-0 h-[3px]"
                         style="background:linear-gradient(90deg,hsl(12 76% 61%),hsl(27 87% 67%))"></div>
                    <div class="flex items-start justify-between mb-3">
                        <div class="w-9 h-9 rounded-md flex items-center justify-center"
                    ...
                    <div class="h-1 rounded-full" style="background:hsl(0 0% 92.1%)">
                        <div class="h-full rounded-full transition-all duration-1000"
                             style="width:62%;background:linear-gradient(90deg,hsl(12 76% 61%),hsl(27 87% 67%))"></div>
                    </div>
                </div>
                    ...
                    <table v-else class="w-full border-collapse">
                        <thead>
                            <tr style="background:hsl(0 0% 96.1%)">
                                <th class="text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground px-5 py-2.5 border-b border-border">Order ID</th>
                                <th class="text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground px-5 py-2.5 border-b border-border">Customer</th>
                                <th class="text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground px-5 py-2.5 border-b border-border">Items</th>
                                <th class="text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground px-5 py-2.5 border-b border-border">Amount</th>
                                <th class="text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground px-5 py-2.5 border-b border-border">Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr
                            ...
                            >
                                <td class="px-5 py-3 text-xs font-semibold font-mono" style="color:#245c4a">
                                    #{{ order.id }}
                                </td>
                                <td class="px-5 py-3">
                ...
                <div class="flex flex-col gap-4">
                        ...
                        <div class="grid grid-cols-2 gap-2 p-3">
                            ...
                            >
                                ...
                                <div class="w-7 h-7 rounded flex items-center justify-center"
                                     :style="{
                                         background: action.color === 'emerald' ? 'rgba(36,92,74,.1)'   :
                                                     action.color === 'gold'    ? 'rgba(197,160,89,.14)':
                                                     action.color === 'blue'    ? 'hsl(197 37% 24% / .1)':
                                                                                   'hsl(12 76% 61% / .1)',
                                         color:      action.color === 'emerald' ? '#245c4a'  :
                                                     action.color === 'gold'    ? '#7a5800'  :
                                                     action.color === 'blue'    ? 'hsl(197 37% 24%)':
                                                                                   'hsl(12 76% 38%)',
                                     }">
                                    <svg v-if="action.icon === 'plus'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                                    <svg v-if="action.icon === 'orders'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2"/></svg>
                                    <svg v-if="action.icon === 'chart'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                                    <svg v-if="action.icon === 'settings'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                                </div>
                    ...
                    <div class="bg-white rounded-xl border border-border shadow-sm overflow-hidden flex-1">
                        ...
                        <div v-else>
                            ...
                            >
                                <div class="w-8 h-8 rounded flex items-center justify-center text-base flex-shrink-0"
                                     style="background:hsl(0 0% 96.1%)">
                                    {{ item.emoji ?? '📦' }}
                                </div>
